  ...
  return (
    <>
      <TouchableOpacity style={styles.headerIconBtn} onPress={() => setOpen(true)}>
        <UserIcon size={18} color={isDark ? '#2DD4BF' : CustomerColors.primary} />
      </TouchableOpacity>
          ...
          <Pressable style={styles.menuCard} onPress={() => {}}>
            ...
            <View style={styles.menuLinks}>
              ...
              <TouchableOpacity style={styles.menuItem} onPress={() => go('AccountSettings', { initialTab: 'account' })}>
                <SettingsIcon size={15} color={isDark ? '#9CA3AF' : '#9CA3AF'} />
                <Text style={styles.menuItemText}>Settings</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.menuItem} onPress={() => go('AccountSettings', { initialTab: 'preferences' })}>
                <SlidersHorizontal size={15} color={isDark ? '#9CA3AF' : '#9CA3AF'} />
...
const getStyles = (isDark: boolean) => StyleSheet.create({
  center: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: isDark ? '#0a0f1d' : CustomerColors.bg, padding: 32, gap: 8 },
  noStoreTitle: { fontSize: 18, fontWeight: '700', color: isDark ? '#F9FAFB' : CustomerColors.black, marginTop: 8 },
  noStoreSubtitle: { fontSize: 13, color: isDark ? '#9CA3AF' : CustomerColors.textSecondary, textAlign: 'center' },
  headerTitleWrap: { alignItems: 'center' },
  headerNameRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  headerStoreName: { fontSize: 15, fontWeight: '800', color: isDark ? '#F9FAFB' : CustomerColors.black, maxWidth: 220 },
  headerTabTitle: { fontSize: 11, color: isDark ? '#9CA3AF' : CustomerColors.textSecondary, marginTop: 1 },
  ...
  menuBackdrop: { flex: 1, backgroundColor: 'rgba(0,0,0,0.4)', alignItems: 'flex-end', paddingTop: 56, paddingRight: 12 },
  menuCard: { width: 250, backgroundColor: isDark ? '#111827' : '#fff', borderRadius: 16, borderWidth: 1, borderColor: isDark ? '#1F2937' : CustomerColors.steelBorder, overflow: 'hidden', elevation: 6, shadowColor: '#000', shadowOpacity: 0.15, shadowRadius: 12, shadowOffset: { width: 0, height: 4 } },
  menuHeader: { paddingHorizontal: 16, paddingVertical: 12, backgroundColor: isDark ? 'rgba(15, 163, 177, 0.15)' : '#DFF1F1', borderBottomWidth: 1, borderBottomColor: isDark ? '#1F2937' : CustomerColors.steelBorder },
  ...
  verifiedBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: isDark ? 'rgba(34, 197, 94, 0.2)' : '#DCFCE7', paddingHorizontal: 7, paddingVertical: 2, borderRadius: 999 },
  verifiedBadgeText: { fontSize: 9, fontWeight: '700', color: isDark ? '#4ADE80' : '#15803D' },
  unverifiedBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: isDark ? 'rgba(217, 119, 6, 0.2)' : '#FEF3C7', paddingHorizontal: 7, paddingVertical: 2, borderRadius: 999 },
  ...
  menuDivider: { height: 1, backgroundColor: isDark ? '#1F2937' : CustomerColors.steelBorder, marginVertical: 4 },
});
